...
export default function CampaignDetail({ campaignId, token }: CampaignDetailProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Cover */}
      <div className="h-64 bg-gradient-to-br from-purple-600 to-pink-500 rounded-xl overflow-hidden relative mb-8">
      ...
      {isLocked ? (
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-8 text-center">
          <svg className="w-12 h-12 text-purple-500 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
          </svg>
          <h2 className="text-xl font-bold text-purple-900 mb-2">Premium Campaign</h2>
          <p className="text-purple-700 mb-6">Upgrade your plan to view the full details and apply to this campaign.</p>
          <a href="/subscriptions" className="inline-block bg-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-purple-700 transition">
            Upgrade Now
          </a>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
                ...
                <div className="space-y-3">
                  {campaign.deliverables.map((del) => (
                    <div key={del.id} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                      <span className="w-8 h-8 bg-purple-100 text-purple-600 rounded-lg flex items-center justify-center text-sm font-bold flex-shrink-0">
                        {del.quantity}
                      </span>
                      <div>
            ...
            {showApplyForm && campaign.can_apply && (
              <section className="bg-white border border-purple-200 rounded-xl p-6">
                ...
                <form onSubmit={handleApply} className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <button
                      type="submit"
                      disabled={applying}
                      className="bg-purple-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-purple-700 transition disabled:opacity-50"
                    >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border rounded-xl p-6 space-y-4 sticky top-4">
              ...
              {campaign.can_apply ? (
                ...
                <a
                  href="/subscriptions"
                  className="block w-full text-center bg-purple-50 text-purple-700 py-3 rounded-lg font-semibold hover:bg-purple-100 transition"
                >
                  Upgrade to Apply
                </a>
              ) : null}
